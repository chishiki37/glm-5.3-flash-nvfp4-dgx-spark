#!/usr/bin/env bash
# TP2 DFlash2 launcher for 9105 (rank0, head) + bdea (rank1).
# Single-variable A/B vs report-01 arm s3: identical flags, drafter swapped MTP3 -> DFlash2.
# Usage: launch_tp2_dflash2.sh <0|1>
set -euo pipefail
NODE_RANK="${1:?usage: launch_tp2_dflash2.sh <0|1>}"
...
echo "launched $NAME rank=$NODE_RANK dflash2 tp2"
sleep 2
