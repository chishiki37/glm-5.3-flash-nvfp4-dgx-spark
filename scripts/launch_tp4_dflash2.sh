...
case "$NODE_RANK" in
  0) HOST_IP=10.10.10.14; HEADLESS=""; MODEL_HOST_PATH="/home/vikassridhar/models/glm-5.3-flash-nvfp4"; DRAFT_HOST_PATH="/home/vikassridhar/models/GLM-5.3-Flash-DFlash2" ;;
  1) HOST_IP=10.10.10.12; HEADLESS="--headless"; MODEL_HOST_PATH="/var/tmp/models-cb98/glm-5.3-flash-nvfp4"; DRAFT_HOST_PATH="/var/tmp/models-cb98/GLM-5.3-Flash-DFlash2" ;;
  2) HOST_IP=10.10.10.1;  HEADLESS="--headless"; MODEL_HOST_PATH="/var/tmp/models-cb98/glm-5.3-flash-nvfp4"; DRAFT_HOST_PATH="/var/tmp/models-cb98/GLM-5.3-Flash-DFlash2" ;;
  3) HOST_IP=10.10.10.2;  HEADLESS="--headless"; MODEL_HOST_PATH="/var/tmp/models-cb98/glm-5.3-flash-nvfp4"; DRAFT_HOST_PATH="/var/tmp/models-cb98/GLM-5.3-Flash-DFlash2" ;;
